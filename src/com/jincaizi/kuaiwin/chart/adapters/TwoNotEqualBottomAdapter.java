 ...
 */
public class TwoNotEqualBottomAdapter extends BaseTableAdapter {
    ...
    public View getView(int row, int column, View convertView, ViewGroup parent) {
        ...
        if (column == -1)
        {
            ...
            textView.setText("选号(二不同号)");
            number.setVisibility(View.GONE);
            imageView.setVisibility(View.GONE);
        }
        else {
            textView.setVisibility(View.GONE);
            number.setText(NumberUtil.getHeaderNumber(column) + "");
    ...
    public TwoNotEqualBottomAdapter(Context context)
    {
