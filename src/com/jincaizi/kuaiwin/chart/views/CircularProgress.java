...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        mColors = new int[4];
        mColors[0] = context.getResources().getColor(R.color.title_orange);
        mColors[1] = context.getResources().getColor(R.color.mark_green);
        mColors[2] = context.getResources().getColor(R.color.counter_second);
        mColors[3] = context.getResources().getColor(R.color.counter_forth);
