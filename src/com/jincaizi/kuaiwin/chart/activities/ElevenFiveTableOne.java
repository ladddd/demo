 ...
 */
public class ElevenFiveTableOne extends BaseTableActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.eleven_five_table_one);
        ...
        LinearLayout firstSelectLayout = (LinearLayout) findViewById(R.id.base_list_bottom);
        LinearLayout secondSelectLayout = (LinearLayout) findViewById(R.id.form_list_bottom);

        initBottom(firstSelectLayout, 0);
        initBottom(secondSelectLayout, 1);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    {
                        baseListAdapter = new ElevenFiveFigureAdapter(ElevenFiveTableOne.this, responseData, 0);
                    ...
                    {
                        formListAdapter = new ElevenFiveFigureAdapter(ElevenFiveTableOne.this, responseData, 1);
