 ...
 *
 */
public class HemaiZongjineFragment extends Fragment implements OnRefreshListener{
	public static final String TAG = "HemaiZongjineFragment";
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		mFootView = LayoutInflater.from(getActivity()).inflate(R.layout.pulltorefreshlistview_footer, null);
		...
		//test data
//		Log.d(TAG, "current lotteryType = " + mParentFragment.mLotteryType.toString());
//		Log.d(TAG, "isJinduSortUp = " + mParentFragment.isJinduSortUp);
//		Log.d(TAG, "isZongjineSortUp = " + mParentFragment.isZonjineSortUp);
	}
...
//				if(LotteryType.getLotteryType(mList.get(arg2 - 1).getLotteryType()) == LotteryType.BJDC ||
//						LotteryType.getLotteryType(mList.get(arg2 - 1).getLotteryType()) == LotteryType.JCLQ ||
//								LotteryType.getLotteryType(mList.get(arg2 - 1).getLotteryType()) == LotteryType.JCZQ) {
//					intent.putExtra("lotterykind", "jingcai");
//				} else {
