...
public class CyptoUtils {
    ...
    public static final String SPEC = "12345678";
    ...
    public static String decode(String key, String data) {
        ...
        try {
            ...
            return new String(cipher.doFinal(_hex2byte(data.getBytes())));
        } catch (Exception e) {
            e.printStackTrace();
            return data;
        }
     ...
     * @return
     */
    private static String _byte2hex(byte[] b) {
    ...
    private static byte[] _hex2byte(byte[] b) {
        if ((b.length % 2) != 0) {
