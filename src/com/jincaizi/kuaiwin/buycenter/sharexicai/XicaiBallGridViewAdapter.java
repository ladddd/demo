 ...
 * @author yj
 */
public class XicaiBallGridViewAdapter extends BaseAdapter {
    private final Context mContext;
    private final String[] mData;
    private final ArrayList<Boolean>mChecked;
    private final boolean mIsRed;

    public XicaiBallGridViewAdapter(Context context,String[] data, ArrayList<Boolean>checked, boolean isRed) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(mChecked.get(position)) {
         holder.type.setBackgroundResource(checkedBg);
