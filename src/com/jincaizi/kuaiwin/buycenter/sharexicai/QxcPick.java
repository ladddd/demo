...
public class QxcPick extends Activity implements OnClickListener,
...
protected static final String TAG = "QxcPick";
	...
	private void _findViews() {
		((TextView)findViewById(R.id.current_lottery)).setText("七星彩投注");
   ...
   private void _showDaigouDialog() {
		...
		final Dialog localDialog = new Dialog(QxcPick.this, R.style.Theme_dialog);
		View view = LayoutInflater.from(getApplicationContext()).inflate(
				R.layout.dialog_submit_bet, null);
		TextView dialogTitle = (TextView) view
				.findViewById(R.id.submit_dialog_title);
	...
	public void onClick(View v) {
		...
		case R.id.random_select_1:
			...
			result = PlsRandom.getPLSBallRePeat(7);
		...
		case R.id.continue_pick:
			Intent continuePick = new Intent(QxcPick.this, Qxc.class);
		   ...
		   for(int i=0; i<mBallList.size(); i++) {
			   if(i != 0) {
				   ...
				   contentBuilder.append(str.substring(0, 1)+"|" + str.substring(1, 2) +"|" + str.substring(2, 3)
						   ...
						   +"|" + str.substring(5, 6) +"|" + str.substring(6, 7));
		   }
		   itemContents = contentBuilder.toString();
		   selectType = typeBuilder.toString();
		Intent submitGroupBuy = new Intent(QxcPick.this,
				GroupBuyXiCai.class);
		submitGroupBuy.putExtra(GroupBuyXiCai.FENSHU, betMoney);
		submitGroupBuy.putExtra("lotterytype", Constants.LotteryType.QXC.toString());
    ...
    private void doGroupBuyHint() {
    	final Dialog groupBuyDialog = new Dialog(QxcPick.this, R.style.Theme_dialog);
		View view = LayoutInflater.from(getApplicationContext()).inflate(
				R.layout.dialog_submit_bet, null);
		TextView dialogTitle = (TextView) view
				.findViewById(R.id.submit_dialog_title);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		// TODO Auto-generated method stub
			mMemoryPostion = arg2;
			Intent retryPick = new Intent(QxcPick.this, Qxc.class);
	...
	_showTouzhuProgress();
	  ...
	  JinCaiZiHttpClient.postFormData(this, url, rawParams, new AsyncHttpResponseHandler() {
		...
		public void onSuccess(int statusCode, Header[] headers,
			...
			try {
				String charset;
				if(Utils.isCmwapNet(QxcPick.this)) {
					charset = "utf-8";
				} else {
					charset = "gb2312";
				}
				String jsonData = new String(responseBody, charset);
				Log.d(TAG, "post qxc form data = " + jsonData);
				parseTouzhuJson(jsonData);
			} catch (UnsupportedEncodingException e) {
				e.printStackTrace();
				Toast.makeText(QxcPick.this, "数据可能异常，请检查数据请求是否成功，以免重复请求造成损失", Toast.LENGTH_LONG).show();
			} catch (Exception e) {
				e.printStackTrace();
				Toast.makeText(QxcPick.this, "数据可能异常，请检查数据请求是否成功，以免重复请求造成损失", Toast.LENGTH_LONG).show();
			} finally {
				...
				localOK.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						 ...
						 if(!TextUtils.isEmpty(successR) && successR.equals("success")) {
							 Intent mSsqIntent = new Intent(QxcPick.this, Qxc.class);
							 ...
							 Intent loginIntent = new Intent(QxcPick.this, Login.class);
							 startActivityForResult(loginIntent, LOGINREQUESTCODE);
						 }
		...
		public void onFailure(int statusCode, Header[] headers,
			...
			Toast.makeText(QxcPick.this, responseMsg, Toast.LENGTH_SHORT).show();
			//finish();
		}
	});  
