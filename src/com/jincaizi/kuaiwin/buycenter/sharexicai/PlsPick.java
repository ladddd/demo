...
public class PlsPick extends Activity implements OnClickListener,
...
protected static final String TAG = "PlsPick";
	...
	private void _findViews() {
		((TextView)findViewById(R.id.current_lottery)).setText("排列3投注");
	...
	private void _showDaigouDialog() {
		...
		final Dialog localDialog = new Dialog(PlsPick.this, R.style.Theme_dialog);
		View view = LayoutInflater.from(getApplicationContext()).inflate(
				R.layout.dialog_submit_bet, null);
		TextView dialogTitle = (TextView) view
				.findViewById(R.id.submit_dialog_title);
	...
	public void onClick(View v) {
		...
		case R.id.continue_pick:
			Intent continuePick = new Intent(PlsPick.this, Pls.class);
	...
	private void startGroupBuy(int betMoney) {
		...
		Intent submitGroupBuy = new Intent(PlsPick.this,
				GroupBuyXiCai.class);
		submitGroupBuy.putExtra(GroupBuyXiCai.FENSHU, betMoney);
		submitGroupBuy.putExtra("lotterytype", Constants.LotteryType.PL3.toString());
    ...
    private void doGroupBuyHint() {
    	final Dialog groupBuyDialog = new Dialog(PlsPick.this, R.style.Theme_dialog);
		View view = LayoutInflater.from(getApplicationContext()).inflate(
				R.layout.dialog_submit_bet, null);
		TextView dialogTitle = (TextView) view
				.findViewById(R.id.submit_dialog_title);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		if (mTypeList.get(arg2) == PlsType.ZUSAN || mTypeList.get(arg2) == PlsType.HEZHIZUSAN) {
			...
			mMemoryPostion = arg2;
			Intent retryPick = new Intent(PlsPick.this, Pls.class);
   ...
   private void _postFormData() {
	   ...
	   rawParams.add("hemaiTitle", "排列3第"+mQihao+"期合买");
	  ...
	  JinCaiZiHttpClient.postFormData(this, url, rawParams, new AsyncHttpResponseHandler() {
		...
		public void onSuccess(int statusCode, Header[] headers,
			...
			try {
				String charset;
				if(Utils.isCmwapNet(PlsPick.this)) {
					charset = "utf-8";
				} else {
					charset = "gb2312";
				}
				...
				e.printStackTrace();
				Toast.makeText(PlsPick.this, "数据可能异常，请检查数据请求是否成功，以免重复请求造成损失", Toast.LENGTH_LONG).show();
			} catch (Exception e) {
				e.printStackTrace();
				Toast.makeText(PlsPick.this, "数据可能异常，请检查数据请求是否成功，以免重复请求造成损失", Toast.LENGTH_LONG).show();
			} finally {
				...
				localOK.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						 ...
						 if(!TextUtils.isEmpty(successR) && successR.equals("success")) {
							 Intent mSsqIntent = new Intent(PlsPick.this, Pls.class);
							 ...
							 Intent loginIntent = new Intent(PlsPick.this, Login.class);
							 startActivityForResult(loginIntent, LOGINREQUESTCODE);
						 }
		...
		public void onFailure(int statusCode, Header[] headers,
			...
			Toast.makeText(PlsPick.this, responseMsg, Toast.LENGTH_SHORT).show();
			//finish();
		}
	});  
