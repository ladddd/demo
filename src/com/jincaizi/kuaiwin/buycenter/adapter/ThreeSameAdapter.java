 ...
 */
public class ThreeSameAdapter extends BaseAdapter{

    private K3_hz_fragment fragment;

    private boolean[] selectedNumber;

    public ThreeSameAdapter(K3_hz_fragment fragment, boolean[] selectedNumber)
    {
    ...
    public View getView(final int i, View convertView, ViewGroup viewGroup) {
        ...
        holder.type.setText(String.valueOf((i+1)*100 + (i+1)*10 + (i+1)));
        holder.tips.setText(fragment.getActivity().getApplicationContext()
                .getString(R.string.number_tips, 240));
