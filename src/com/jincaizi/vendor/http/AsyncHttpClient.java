...
package com.jincaizi.vendor.http;
...
public class AsyncHttpClient {
     ...
     */
    public void setProxy(String hostname, int port, String http) {
        final HttpHost proxy = new HttpHost(hostname, port, http);
        final HttpParams httpParams = this.httpClient.getParams();
    ...
    public RequestHandle post(Context context, String url, RequestParams params, ResponseHandlerInterface responseHandler) {
        ...
        return post(context, url, paramsToEntity(params, responseHandler), "application/x-www-form-urlencoded", responseHandler);
    }
    public RequestHandle post(Context context, String url, RequestParams params, ResponseHandlerInterface responseHandler, String contentType) {
    	//getHttpClient().getConnectionManager().closeExpiredConnections();
